...
let botoArticle = <HTMLButtonElement>document.getElementById('BotoArticle');

botoArticle.addEventListener('click', function () {
    // Obtenemos el valor del campo en el momento del clic
    let titol = (<HTMLInputElement>document.getElementById('titol')).value;
...
function campsComplets(titol: string): boolean {
